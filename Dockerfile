...
LABEL org.opencontainers.image.source="https://github.com/agile-learning-institute/mentorhub_member_api"
...
CMD exec python -m gunicorn --bind 0.0.0.0:8393 src.server:app